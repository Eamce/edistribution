import 'package:edistribution/privacy/dataConsent.dart';
...
class DataPrivacy extends StatelessWidget {
  final String useFor;
  const DataPrivacy({Key? key, required this.useFor}) : super(key: key);
                  ...
                  children: [
                    ...
                    RichText(
                      ...
                      text: TextSpan(
                        children: [
                          TextSpan(
                            text: "My NETgosyo mobile sites/apps.",
                            style: TextStyle(
                                fontSize: 12,
                                fontWeight: FontWeight.bold,
                                color: Colors.black),
                          ...
                          TextSpan(
                            text:
                                " Consumer-directed mobile sites or applications operated by or for My NETgosyo, such as smartphone apps.",
                            style: TextStyle(fontSize: 12, color: Colors.black),
                          ),
                        ],
                      ),
                    ...
                    RichText(
                      ...
                      text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text:
                                " Interactions with electronic communications between you and My NETgosyo.",
                            style: TextStyle(fontSize: 12, color: Colors.black),
                          ),
                        ],
                      ),
                    ...
                    RichText(
                      ...
                      text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text:
                                " Third party social such as Facebook and Google, market research (if feedback not provided on an anonymous basis), third-party data aggregators, My NETgosyo promotional partners, public sources and data received when we acquire other companies.",
                            style: TextStyle(fontSize: 12, color: Colors.black),
                          ),
                        ],
                      ),
                    ...
                    SizedBox(height: 5),
                    Text(
                      "We collect and process your personal in accordance with the Data Privacy Act of 2012 and with the specific purposes outlined in this Notice. Depending on how you interact with My NETgosyo, these data may include:",
                      style: TextStyle(fontSize: 12),
                      textAlign: TextAlign.justify,
                    ),
                    SizedBox(height: 5),
                    ...
                    RichText(
                      ...
                      text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text:
                                "Right to file a complaint and be indemnified. ",
                            style: TextStyle(fontSize: 12, color: Colors.black),
                          ),
                          TextSpan(
                            text:
